...
import { hasTypeorm, hasValidator, swagger } from "../utils";
...
export function setGuards(guards: any[], func: Function) {
    Reflect.defineMetadata(GUARDS_METADATA, guards, func);
}
...
function setSwagger(params: any[], func: Function) {
    ...
    Reflect.defineMetadata(
        swagger.DECORATORS.API_PARAMETERS,
        [...metadata, ...params],
        func,
    );
}
